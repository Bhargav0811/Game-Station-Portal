...
for(i=0;i<3;i++)
{
  ...
  if(JSON.stringify(C)==JSON.stringify(a1) || JSON.stringify(m[i])==JSON.stringify(a1)){return 1;}
  else if(JSON.stringify(C)==JSON.stringify(a2) || JSON.stringify(m[i])==JSON.stringify(a2)){return 2;}
}

var b1 = [m[0][0],m[1][1],m[2][2]];
var b2 = [m[2][0],m[1][1],m[0][2]];

if(JSON.stringify(b1)==JSON.stringify(a1) || JSON.stringify(b2)==JSON.stringify(a1)){return 1;}
else if(JSON.stringify(b1)==JSON.stringify(a2) || JSON.stringify(b2)==JSON.stringify(a2)){return 2;}
